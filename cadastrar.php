...
if($btnCadUsuario){
	...
	if(!$erro){
		...
		$result_usuario = "INSERT INTO usuarios (nome, email, setor, usuario, senha) VALUES (
						'" .$dados['nome']. "',
						'" .$dados['email']. "',
						'" .$dados['setor']. "',
						'" .$dados['usuario']. "',
...
<html lang="pt-br">
	...
	<body>
		<div class="container">
			<div class="form-signin" style="background: #8A2BE2;">
				<img src="logo.png" class="img-fluid img-thumbnail">
				<strong><h2>Cadastrar Usuário</h2></strong>
				<?php
				...
				<form method="POST" action="">
					...
					<!--<label>Setor</label>-->
					<input type="text" name="setor" placeholder="Digite o seu setor" class="form-control"><br>

					<!--<label>Usuário</label>-->
					<input type="text" name="usuario" placeholder="Digite sua matrícula" class="form-control"><br>
					...
					<div class="row text-center" style="margin-top: 20px;">
						<strong>Lembrou? <a href="login.php">Clique aqui</a> para logar</strong>
					</div>
				</form>
			</div>
		</div>
